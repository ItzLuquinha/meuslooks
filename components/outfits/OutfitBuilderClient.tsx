...
export default function OutfitBuilderClient() {
  ...
  async function load() {
    ...
    const list: BuilderOutfit[] = Array.isArray(outfits.outfits) ? outfits.outfits : [];
    setSaved(list);
